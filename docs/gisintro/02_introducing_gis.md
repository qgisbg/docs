...
|----------------|---------------|--------|------|
| 23.326922      | 42.670454     | ковид19        | 2020-01-13 |
| 23.327393      | 42.670426     | ковид19        | 2020-01-18 |
| 23.327146      | 42.670151     | ковид19        | 2020-01-30 |
| 23.327561      | 42.672465     | грип           | 2020-02-08 |
| 23.327365      | 42.672554     | грип           | 2020-02-17 |
| 23.326994      | 42.672082     | грип           | 2020-02-20 |


От пръв поглед в таблицата по-горе се забелязват множество заболели от ковид19 през януари и от грип през февруари. Не толкова очевидно е обаче разпространението на нашите пациенти в пространството, освен ако не ги визуализираме в ГИС приложение.

![Изглежда, болните от грип живеят недалеч едни от други, както и тези, болни от ковид19, и не са спазили мерките за карантина.](img/bg_patients_diseases.png)
...
![Едно от най-популярните ГИС приложения в света.](img/bg_google_maps_horizontal.png)
...
![Картният обзор с един зареден слой общини.](img/bg_municipalities.png)

![Картен обзор с няколко заредени слой с общини и жп линии. Забележете как новия слой припокрива вече заредения слой с общинските граници.](img/bg_mun_railways.png)
...
![Смяната на реда на слоевете позволява да се променя изобразяването на картата. Така ако искаме да покажем карта на пътищата, най-вероятно искаме те да са върху реките, вместо под тях.](img/bg_roads_rivers_paz.png)
...
![Например, ако изберем **Add a new layer** от менюто, ще добавим нов свой с географски данни на екрана.](img/add_layer.png)
...
![Векторните данни се използват за изобразяване на точки (напр. градове, дървета), линии (напр. реки, пътища, тръбопроводи) и полигони (напр. общински граници, застроена площ).](img/bg_obl_rivers.png)
...
![Растерните данни най-често са аерокосмически изображения. Ето снимка на Седемте рилски езера с нормално приближение.](img/bg_seven_rila_lakes.png)

![Същите растерни данни, но с прекомерно приближение.](img/bg_seven_rila_lakes_zoomed.png)
